...
function Footer() {
  return (
    <footer style={{ backgroundColor: '#011a54' }} class="text-gray-600 body-font">
        ...
        <div class="flex flex-wrap md:text-left text-center order-first">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <li>
              ...
              <li>
                <a class="text-gray-600 hover:text-gray-800">Any Queries : (+1) 234 567 900</a>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <a class="text-gray-600 hover:text-gray-800">NATTY CAFE</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">DOSA CAFE </a>
              </li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <a class="text-gray-600 hover:text-gray-800">F&B Management</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Menu Management / Planning</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Tour & Travels</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Event Management</a>
              </li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button class="ml-auto mr-auto mt-4 block text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">SUBMIT</button>
           
          </div>
        </div>
      </div>
      <div style={{backgroundColor:'#001138'}} class="bg-gray-100">
        <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src={logo} width='100px'/>
            <span class="ml-3 text-xl">Global Hospitality & Consultancy</span>
          </a>
          <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 globalconsultancy 
           </p>
